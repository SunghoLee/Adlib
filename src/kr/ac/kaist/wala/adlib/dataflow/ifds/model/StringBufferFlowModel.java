...
public class StringBufferFlowModel extends ClassFlowModel{
    ...
    protected void init() {
        ...
        methods = new MethodFlowModel[]{
                ...
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(B)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(C)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append([C)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append([CII)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(Ljava/lang/CharSequence;)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(Ljava/lang/CharSequence;II)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(D)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(F)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(I)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(J)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(Ljava/lang/Object;)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(Ljava/lang/String;)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RECEIVERV, MethodFlowModel.RETV}),
