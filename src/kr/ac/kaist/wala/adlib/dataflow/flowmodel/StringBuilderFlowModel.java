...
public class StringBuilderFlowModel extends ClassFlowModel{
    ...
    protected void init() {
        ...
        methods = new MethodFlowModel[]{
                ...
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("append(B)Ljava/lang/StringBuilder;")), new int[]{MethodFlowModel.RECEIVERV, 1}, new int[]{MethodFlowModel.RETV}),
                ...
                MethodFlowModel.make(MethodReference.findOrCreate(ref, Selector.make("insert(IB)Ljava/lang/StringBuilder;")), new int[]{MethodFlowModel.RECEIVERV, 2}, new int[]{MethodFlowModel.RETV}),
