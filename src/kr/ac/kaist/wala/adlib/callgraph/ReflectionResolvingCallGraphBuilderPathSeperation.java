...
public class ReflectionResolvingCallGraphBuilderPathSeperation extends PathSeperationCallGraphBuilder {
    ...
    public ReflectionResolvingCallGraphBuilderPathSeperation(int n, IClassHierarchy cha, AnalysisOptions options, AnalysisCache cache) {
        super(n, cha, options, cache, new FirstMethodContextSelector(new DefaultContextSelector(options, cha)), null);
    }
