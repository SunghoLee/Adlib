...
public class ReflectionResolvingCallGraphBuilderOBJ extends SSAPropagationCallGraphBuilder {
    ...
    public ReflectionResolvingCallGraphBuilderOBJ(IClassHierarchy cha, AnalysisOptions options, AnalysisCache cache, ContextSelector appContextSelector, SSAContextInterpreter appContextInterpreter, int n) {
        ...
        contextSelector = new DelegatingContextSelector(new ReceiverContextSelector(cha, n), contextSelector);
