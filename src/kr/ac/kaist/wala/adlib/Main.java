...
public class Main {
  ...
  public static void main(String[] args) throws CallGraphBuilderCancelException, ClassHierarchyException, ParseException, IOException {
    Config.parse(args);
    String prop = Config.getProperty();
    String sdk = Config.getSDK();
    String initInstFile = Config.getInitInst();
    ...
    double cgTime = (cgEnd - cgStart)/1000d;
    ...
    MaliciousPatternChecker.Results res = mpc.checkPatterns();
    ...
    System.out.println("#CallGraph Construction Time: " + cgTime + "s");
    System.out.println("#Total Analysis Time: " + ((pcEnd - start)/1000d) + "s");
    System.out.println("#Total Program Points: " + mpc.getTotalProgramPoint());
    System.out.println("#Total Data Facts: " + mpc.getTotalDF().size());
  }
